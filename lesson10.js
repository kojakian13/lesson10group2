/*A JavaScript function is defind with the function keyword, followed by name, followed by

function name(parameter1, parameter2, parameter3) {
    //code to be executed
}
//Function names can contain letters, digits, underscores, and dollar signs (same rules as var)
//When JavaScript reaches a return statment, the function will stop executing.
...
var message = ('you will need ' + totalNeeded + 'cups of tea');
console.log(message);
}
